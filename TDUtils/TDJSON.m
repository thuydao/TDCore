...
@implementation NSNull (NSObject_TDJSON)
...
@implementation NSNumber (NSObject_TDJSON)
...
@implementation NSString (NSObject_TDJSON)
...
@implementation NSArray (NSArray_TDJSON)
...
- (void)JSONFragmentWithOptions:(opts_t *)x into: (NSMutableString *)json
{
  ...
  - (NSString *)td_JSONRepresentationWithOptions:(NSDictionary *)x
  {
  ...
  @implementation NSDictionary (NSDictionary_TDJSON)
